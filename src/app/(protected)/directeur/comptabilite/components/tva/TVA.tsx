  ...
  if (isProd) {
    return (
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="bg-indigo-50 border-l-4 border-indigo-400 p-6 rounded-md shadow-md">
          <div className="flex items-center mb-4">
            ...
            <h3 className="text-xl font-bold text-indigo-700">Fonctionnalité en développement</h3>
          </div>
          
          <p className="text-indigo-700 mb-4 text-lg">
            Le module de déclaration de TVA est actuellement en cours de développement et sera disponible prochainement.
          </p>
          
          <p className="text-indigo-600">
            Nous travaillons activement sur cette fonctionnalité pour vous offrir une expérience complète de gestion de la TVA :
          </p>
          
          <ul className="mt-3 list-disc list-inside text-indigo-600 space-y-1 ml-4">
            <li>Calcul automatique de la TVA collectée et déductible</li>
            <li>Génération des déclarations aux formats officiels</li>
            <li>Suivi des échéances et paiements</li>
            <li>Historique des déclarations</li>
            <li>Intégration avec les services fiscaux en ligne</li>
          </ul>
        </div>
      </div>
    );

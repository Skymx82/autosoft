  ...
  if (isProd) {
    return (
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="bg-teal-50 border-l-4 border-teal-400 p-6 rounded-md shadow-md">
          <div className="flex items-center mb-4">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-teal-500 mr-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
            </svg>
            <h3 className="text-xl font-bold text-teal-700">Fonctionnalité en développement</h3>
          </div>
          
          <p className="text-teal-700 mb-4 text-lg">
            Le module de gestion des voitures est actuellement en cours de développement et sera disponible prochainement.
          </p>
          
          <p className="text-teal-600">
            Nous travaillons activement sur cette fonctionnalité pour vous offrir une expérience complète de gestion de votre parc automobile :
          </p>
          
          <ul className="mt-3 list-disc list-inside text-teal-600 space-y-1 ml-4">
            <li>Suivi complet des véhicules et de leurs caractéristiques</li>
            <li>Gestion des entretiens et contrôles techniques</li>
            <li>Suivi des assurances et échéances</li>
            <li>Analyse détaillée des coûts</li>
            <li>Gestion des documents liés aux véhicules</li>
          </ul>
        </div>
      </div>
    );
